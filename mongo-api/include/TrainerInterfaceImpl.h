...
#ifndef LIGHTLDA_TRAINERINTERFACEIMPL_H
#define LIGHTLDA_TRAINERINTERFACEIMPL_H
#include "trainer.h"
    ...
    namespace lightlda
    {
        namespace dev {
            ...
            void Trainer<meta_type>::TrainIteration(DataBlockBase *data_block) {
                ...
                const auto &local_vocab = data.meta();
            ...
            /////////////////////////////////////////////////////////////////
            inline void ParamLoader::ParseAndRequest(DataBlockBase *data_block)
            {
                LDADataBlock *lda_data_block = reinterpret_cast<LDADataBlock *>(data_block);
                ...
                for (const int32_t *p = local_vocab.begin(slice); p != local_vocab.end(slice); ++p)
                {
...
#endif //LIGHTLDA_TRAINERINTERFACEIMPL_H
